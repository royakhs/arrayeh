...
public class CalendarTool {
    ...
    public int getIranianWeekDay() {
        String day = getIranianWeekDayStr();
        switch (day) {
            case "شنبه":
                return 0;
            case "یکشنبه":
    ...
    public String getIranianDate(String date) {
        String expireDate = date;
        //CalendarTool calendarTool = new CalendarTool();
        setGregorianDate(Integer.valueOf(expireDate.substring(0, 4)), Integer.valueOf(expireDate.substring(5, 7)), Integer.valueOf(expireDate.substring(8, 10)
        ));
        getIranianYear();
        getIranianMonth();
        getIranianDay();
        return String.valueOf(getIranianDay()) + " / " +
                getMonthName(getIranianMonth()) + " / " +
                String.valueOf(getIranianYear());
    }
